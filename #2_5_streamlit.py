...
def main():
    ...
    <div class="guide-box">
        ...
        <div class="guide-item">
            ...
            연속된 요청은 성능을 저하하는 원인이 될 수 있습니다. 왼쪽 대화초기화를 통해 새롭게 세션을 구성하세요.<br>
            확장질문을 할때에도 최대한 질문을 구체적으로 작성해야 검색에 도움이 됩니다.<br>
            예) "과의존 여부에 따른 sns 이용정도" → "AI 답변" → "청소년은?" x "과의존 여부에 따른 sns이용정도에 대해 청소년은 어떻게 나타나?"
        </div>
        <div class="guide-item">
            <strong>⚠️ 주의:</strong> AI 답변에 <strong>오류(할루시네이션)</strong>가 있을 수 있습니다. <br>
            검색 결과를 바로 인용하지 마시고, <strong>원문을 통해 한번 더 확인한 뒤</strong> 정보를 최종적으로 사용하십시요.<br>
